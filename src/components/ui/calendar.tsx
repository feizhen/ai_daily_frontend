  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          "bg-black text-white hover:bg-black/95 hover:text-white focus:bg-black focus:text-white rounded-full font-medium",
        today: "bg-gray-100 text-black font-medium rounded-full ring-1 ring-gray-300",
        outside:
